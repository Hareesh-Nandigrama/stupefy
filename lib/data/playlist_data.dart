  ...
  if (mix == "Drake mix") {
    return Playlist(
      ...
      [
        ...
        PLaylistTrack("drake mix/Nice-For-What.jpg", "Drake ", "Nice For What"),
        PLaylistTrack(
    ...
    return Playlist(
      ...
      [
        ...
        PLaylistTrack(
            "chill/Come-Back-to-Earth.jpg", "Mac Miller", "Come Back to Earth"),
    ...
    return Playlist(
      ...
      [
        ...
        PLaylistTrack("2010/Sunflower - Spider-Man_ Into-the-Spider-Verse.jpg",
            "Post Malone", "Sunflower - Spider-Man: Into the Spider-Verse"),
        PLaylistTrack("2010/Cruel-Summer.jpg", "Taylor Swift", "Cruel Summer"),
        PLaylistTrack(
        ...
        PLaylistTrack(
            "2010/Evergreen.jpg", "Richy Mitch & The Coal Miners", "Evergreen"),
      ],
    );
  }
